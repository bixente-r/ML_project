...
"""
Version 2 projet ML (overall accuracy replaced by preision on 1 and 0) - training on imbalanced file
"""
...
def init_frame(path, id_col=0):
    ...
    return X1,y1, X2,y2, corr_matrix
...
training_set, training_output, validation_set, validation_output,corr_matrix = init_frame(path)
